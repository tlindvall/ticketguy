  ...
  return (
    <main className="tg-container">
      ...
      <div className="mt-4 space-y-3 text-gray-800">
        ...
        <p><strong>AI processing.</strong> Extraction and drafting send the text of your request (and any screenshots you attach) to Anthropic&apos;s API. Anthropic&apos;s own retention terms and our account configuration govern what is kept there; both will be described accurately here before launch. Comparison math, ranking, buy/wait rules and every figure in our replies are computed in our own code, not by the model.</p>
